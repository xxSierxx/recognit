...
//Добавить анализ по цвету: Суть в то, чтобы после вычисления формы мы находили кубики и далее с помощью среднего арифметического всех цветов мы отбрасывали те фигуры, которые по цвету не подошли
//Аналогично с цветом, но по размерам. Для этого мы анализируем размер фигуры и отбрасываем все лишнее. По сути говоря, необходимо добавить алгоритмы размера.
